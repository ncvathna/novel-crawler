...
{
    [Serializable]
    class VolareNovels : Chapter
    {
        public VolareNovels(int id, string name, string url) : base(id, name, url) { }
        public override void Parse()
        {
            ...
            // Get Content
            HtmlNode contentNode = doc.DocumentNode.SelectSingleNode("//div[contains(@class, 'jfontsize_content')]");
